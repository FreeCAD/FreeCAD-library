...
for data in Table:
    ...
    App.ActiveDocument.saveAs(LIBRARYPATH+'/Mechanical Parts/Profiles/EN10058 Flat steel bars/'+data[0]+'.FCStd')
    __objs__=[]
    __objs__.append(FreeCAD.getDocument(App.ActiveDocument.Name).getObject("Extrude"))
    ImportGui.export(__objs__,LIBRARYPATH+'/Mechanical Parts/Profiles/EN10058 Flat steel bars/'+data[0]+'.step')
    Mesh.export(__objs__,LIBRARYPATH+'/Mechanical Parts/Profiles/EN10058 Flat steel bars/'+data[0]+'.stl')
    del __objs__
